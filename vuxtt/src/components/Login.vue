    ...
    <div>
        ...
        <div>
            <group>
                ...
                <x-input title="密码：" autocomplete="new-password" ref="pwdInput" @keyup.enter.native="pwdEnter" style="padding:15px" type="password" :max="15"   v-model="password" placeholder="输入小秘密"></x-input>
            </group>
